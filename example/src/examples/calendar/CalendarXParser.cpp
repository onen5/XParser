    ...
    mObjStack()
{
    ...
    addStartTagHandler( "weekdays", [ this ]() {
        auto exampleAttrib = getStringAttrib( "example-attrib" );
        auto noAttrib      = getStringAttrib( "noAtttrib", "Default Value" );

        cout << "processing weekdays" << endl;
        cout << "exampleAttrib: " << exampleAttrib << endl;
        cout << "noAttrib: " << noAttrib << endl;
    } );
